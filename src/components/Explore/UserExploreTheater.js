...
import {Container, Card, CardHeader, CardBody, CardTitle, FormGroup, Label, Input, Row, Col} from 'reactstrap';
import $ from 'jquery';
        ...
        return (
            <ContentWrapper>
                ...
                <Container fluid>
                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle><h3>Explore Theater</h3></CardTitle>
                        </CardHeader>
                        ...
                        <CardBody>
                            {/*<Datatable options={this.state.dtOptions1}>*/}
                                <table className="table table-striped my-4 w-100">
                                    ...
                                    <tr>
                                        ...
                                        <th className="sort-numeric">Address</th>
                                        <th className="sort-numeric">Company</th>
                            ...
                            <Row>
                                ...
                                <Col>
                                    <div className="float-left">
                                        <button to="login" className="btn btn-primary mr-4">Log Visit</button>
                                    </div>
                                </Col>
