...
class ManagerOnly extends Component {
    constructor(props){
        super(props)
        this.state = {
            passwordError: ''
    ...
    onSubmit = (e) => {
        ...
        if((this.props.confPassword).trim() !== (this.props.password).trim()) {
            ...
            return axios.post('http://localhost:8080/api/v1/auth/signup/manager', this.jsonGen())
                .then(res => {
                    this.notify()
                    setTimeout(() =>  this.props.history.push('/login'), 3000)
                    console.log('The manager has been successfully registered!')
                    // console.log(res);
            ...
            <div className="block-center mt-4" style={{width:"800px"}}>
                ...
                <div className="card card-flat">
                    ...
                    <div className="card-body">
                        <ToastContainer />
                        <h3><p className="text-center py-2">MANAGER-ONLY REGISTRATION</p></h3>
                            ...
                            <CardBody>
                                ...
                                <div className="pt-2 clearfix">
                                    <p className="float-right text-sm">
                                        <i>All fields with are required here</i>
                                    </p>
...
export default connect(mapStateToProps)(ManagerOnly);
