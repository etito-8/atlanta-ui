        ...
        return (
            <ContentWrapper>
                ...
                <Container fluid>
                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle><h3>Theater Overview</h3></CardTitle>
                        </CardHeader>
                        ...
                        <CardBody>
                            {/*<Datatable options={this.state.dtOptions1}>*/}
                                <table className="table table-striped my-4 w-100">
                                    <thead>
                                    <tr>
                                        <th data-priority="1">Movie Name</th>
                                        <th className="sort-numeric">Duration</th>
                                        <th className="sort-numeric">Release Date</th>
                                        <th className="sort-numeric">Play Date</th>
